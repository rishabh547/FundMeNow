...
export default (props) => {
  return (
    <div className="bg-black flex-col align-items-center justify-items-center ">
      ...
      <div className="flex ">
        <div className="container shadow-white shadow-2xl border-0 rounded-lg p-12 my-8 mx-20 text-white" style={{ "fontSize": "80px", "width": "40%" }
        }>
          <div className="animate-pulse">
            <p>Fund Me</p>
            <p className="text-cyan-500 ">Now</p>
          </div>
          <Image src={svgImg} width={500} height={301} />
        </div >
